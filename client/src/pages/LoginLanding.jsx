  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Access the admin dashboard to manage employees, attendance, and leave requests.",
      icon: ShieldIcon
    },
    {
      to: "/login/employee",
      title: "Employee Portal",
      description: "Access your employee dashboard to view your schedule, request leave, and update your information.",
      icon: UserIcon
    },
  ]
  return (
      ...
      <div className='w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen'>
        <div className='w-full max-w-md animate-fade-in relative z-10'>
          ...
          <div className='mb-10 text-center md:text-left'>
            ...
            <p className='text-slate-500'>Select your portal to sequerly access the system.</p>
          </div>
