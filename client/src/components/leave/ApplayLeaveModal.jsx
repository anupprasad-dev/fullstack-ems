...
const ApplayLeaveModal = ({ open, onClose, onSuccess }) => {
        ...
        <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm' onClick={onClose}>
            <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in' onClick={(e) => e.stopPropagation()}>
                ...
                <div className='flex items-center justify-between p-6 pb-0'>
                    <div>
                        <h2 className='text-lg font-semibold text-slate-800'>Applay for leave</h2>
                ...
                <form onSubmit={handleSubmit} className='p-6 space-y-5'>
                    ...
                    <div>
                        ...
                        <select name="type" required className='cursor-pointer'>
                    ...
                    {/* -----------reason---------------- */}
                    <div>
                        <label className='text-sm font-medium text-shadow-slate-700 mb-2 block'>
                            Reason
                        </label>
                    ...
                    <div className='flex gap-3 pt-2'>
                        <button type='button' className='btn-secoundary flex-1 cursor-pointer' onClick={onClose}>
                            Cancel
                        </button>
                        <button type='submit' className='btn-primary flex flex-1 items-center justify-center gap-2 cursor-pointer' disabled={loading} onClick={onclose}>
...
export default ApplayLeaveModal
