        ...
        <form onSubmit={handleSubmit} className='space-y-6 max-w-3xl animate-fade-in'>
            ...
            <div className='card p-5 sm:p-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    <div className='sm:col-span-2'>
                        ...
                        <textarea type="text" name="bio" defaultValue={initialData?.bio} rows={3} className='resize-none' placeholder='Brief description...' />
                    </div>
                </div>
            </div>
            {/* Employment details */}
            <div className='card p-5 sm:p-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    <div>
                        <label className='block mb-2'>Basic Sallary</label>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    {isEditMode && (
                        <div>
                            ...
                            <input type="password" name="password" placeholder='Leave blank to keet current' />
                        </div>
                    )}
                    <div>
                        <label className='block mb-2'>System Role</label>
                        <select name="role" id="" defaultValue={initialData?.user?.role || "EMPLOYEE"}>
