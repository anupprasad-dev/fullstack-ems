...
const EmployeeDashboard = ({ data }) => {
    ...
    const cards = [
        ...
        {
            // icon: DollarSignIcon, original code jadi rupees symbol kama na kala then ai code use haba ok
            icon: () => <span className="text-lg font-semibold">₹</span>,
            value: data.latestPayslip ? `₹${data.latestPayslip.netSalary?.toLocaleString()}` : "N/A", //1st $ is currency symbol, and i remove it if i get suitable rupees symbol in the icon section, 
